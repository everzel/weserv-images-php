...
class WeservImages
{
    ...
    private const BASE_URL = 'https://wsrv.nl';
    ...
    public function __construct(string $imageUrl, ?string $baseUrl = null, bool $isLocal = false)
    {
    ...
    public static function make(string $imageUrl, string $baseUrl = null, bool $isLocal = false): self
    {
        return new static($imageUrl, $baseUrl, $isLocal);
    }
     ...
     * @return $this
     */
    public function w(int $width): self
    {
     ...
     * @return $this
     */
    public function h(int $height): self
    {
     ...
     * @return $this
     */
    public function dpr(int $density): self
    {
    ...
    public function filt(
        ...
        $base = $this->set('filt', $filter);

        if ($filter === Filter::DUOTONE->value) {
            $base = $base
